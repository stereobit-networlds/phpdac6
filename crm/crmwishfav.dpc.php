...
class crmwishfav extends crmmodule  {
	...
	public function wishfav_grid($width=null, $height=null, $rows=null, $mode=null, $noctrl=false) {
	    ...
	    if (defined('MYGRID_DPC')) {
			...
			GetGlobal('controller')->calldpc_method("mygrid.column use grid1+cid|".localize('cid',getlocal())."|1|1|");	//hide by width	(insert field)	
			GetGlobal('controller')->calldpc_method("mygrid.column use grid1+listname|".localize('_listname',getlocal()). "|5|1|");
			...
			GetGlobal('controller')->calldpc_method("mygrid.column use grid1+code5|".localize('_code',getlocal())."|link|4|"."javascript:showdetails(\"{tid}~$selected\");".'||');
			...
			GetGlobal('controller')->calldpc_method("mygrid.column use grid1+tdata|".localize('_tdata',getlocal())."|10|1|");	
			GetGlobal('controller')->calldpc_method("mygrid.column use grid1+tstatus|".localize('_status',getlocal())."|2|1|");				
