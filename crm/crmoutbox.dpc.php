...
class crmoutbox extends crmmodule  {
	...
	public function outbox_grid($width=null, $height=null, $rows=null, $mode=null, $noctrl=false) {
	    ...
	    if (defined('MYGRID_DPC')) {
            ...
            $xSQL2 = "SELECT * from (select id,timein,timeout,receiver,subject,reply,status,mailstatus,cid from mailqueue where receiver='$selected' and origin='crm') o ";
			//echo $xSQL2;
			...
			GetGlobal('controller')->calldpc_method("mygrid.column use grid3+timeout|".localize('_date',getlocal())."|5|1|");//"|link|5|"."javascript:showdetails(\"{receiver}\");".'||');						
